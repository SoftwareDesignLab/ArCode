...
import edu.rit.se.design.specminer.SpecMiner;
import edu.rit.se.design.specminer.fspec.FSpec;
import edu.rit.se.design.specminer.fspec.FSpecBuilder;
import edu.rit.se.design.specminer.fspec.FSpecVisualizer;
import edu.rit.se.design.specminer.graam.GRAAM;
import edu.rit.se.design.specminer.graam.GRAAMBuilder;
import edu.rit.se.design.specminer.ifd.IFD;
import edu.rit.se.design.specminer.util.common.CommonConstants;
...
//        System.out.println( "Final FSpec for test projects:\n" + new FSpecVisualizer( testProjsSpecMiner.getMinedFSpec() ).dotOutput() + "\n");
    ...
    static void swappedAPIExperiment(FSpec fSpec, String serializedTestGRAAMsFolderPath, int maxSwappedAPINum) throws IOException, ClassNotFoundException {
    ...
    static void missedAPIExperiment(FSpec fSpec, String serializedTestGRAAMsFolderPath, int maxRemoveAPINum) throws IOException, ClassNotFoundException {
    ...
    static void nextAPIRecommendationExperiment( FSpec trainProjectsFSpec, String serializedTestGRAAMsFolderPath ) throws IOException, ClassNotFoundException {
